...
void GameScene::Initialize() {
	...
	//頭
	worldTransform_[PartId::Head].translation_ = {0, 9.0f, 0};
	worldTransform_[PartId::Head].parent_ = &worldTransform_[PartId::Chest];
	worldTransform_[PartId::Head].Initialize();

	//左腕
	worldTransform_[PartId::ArmL].translation_ = {-9.0f, 4.5f, 0};
	worldTransform_[PartId::ArmL].parent_ = &worldTransform_[PartId::Chest];
	worldTransform_[PartId::ArmL].Initialize();

	//右腕
	worldTransform_[PartId::ArmR].translation_ = {9.0f, 4.5f, 0};
	...
	//左足
	worldTransform_[PartId::LegL].translation_ = {-9.0f, -9.0f, 0};
	worldTransform_[PartId::LegL].parent_ = &worldTransform_[PartId::Hip];
	worldTransform_[PartId::LegL].Initialize();

	//右足
	worldTransform_[PartId::LegR].translation_ = {9.0f, -9.0f, 0};
...
void GameScene::Update() {
	...
	//	viewProjection_.up.x += move.x;
	//	viewProjection_.up.y += move.y;
	//	viewProjection_.up.z += move.z;
	...
	//	viewProjection_.UpdateMatrix();
		...
		debugText_->Printf("neaeZ:%f", viewProjection_.nearZ);
	/*}*/
	//キャラクター移動処理
	{
		//キャラクターの移動ベクトル
